...
class RegisterationT extends StatefulWidget {
  @override
  _RegisterationTState createState() => _RegisterationTState();
}

class _RegisterationTState extends State<RegisterationT> {
